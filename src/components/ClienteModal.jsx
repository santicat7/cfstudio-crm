...
export default function ClienteModal({ cliente, onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white border border-[#E8E8E8] rounded-sm w-full max-w-lg max-h-[90vh] overflow-y-auto p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-xs font-medium text-[#111] mb-1.5 uppercase tracking-wide">Instagram</label>
              ...
              <div>
                <label className="block text-xs font-medium text-[#111] mb-1.5 uppercase tracking-wide">Email</label>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-[#111] mb-1.5 uppercase tracking-wide">Tipo</label>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-[#111] mb-1.5 uppercase tracking-wide">Paquete</label>
                ...
                <div>
                  <label className="block text-xs font-medium text-[#111] mb-1.5 uppercase tracking-wide">Precio total (USD)</label>
