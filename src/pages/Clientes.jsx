    ...
    <div>
      ...
      <div className="flex gap-2 mb-4">
        <div className="relative flex-1 max-w-xs">
          <Search size={14} className="absolute left-3 top-1/2 -translate-y-1/2 text-[#AAA] dark:text-[#5A5450]" />
          <input
            type="text"
            value={search}
          ...
          filtered.map(c => {
            ...
            return (
              ...
              >
                ...
                <div className="text-sm text-[#666] dark:text-[#998E88]">{c.event_type || '—'}</div>
                <div className="text-sm text-[#666] dark:text-[#998E88]">{formatDate(c.event_date)}</div>
                <div className="text-sm text-[#666] dark:text-[#998E88]">{c.package || '—'}</div>
                <div>
                  {delivery ? (
                    ...
                    <span className="text-sm text-[#CCC] dark:text-[#4A4440]">—</span>
                  )}
                </div>
