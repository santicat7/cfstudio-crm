...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] dark:bg-[#141210] flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-10">
          <div className="text-2xl font-semibold tracking-tight text-[#1A1814] dark:text-[#EDE7DC] mb-1">
            C&amp;F Studio
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2.5 border border-[#D9D9D9] bg-[#FDFBF7] dark:bg-[#1E1B17] text-[#1A1814] dark:text-[#EDE7DC] text-sm rounded-xl outline-none focus:border-[#1A1814] transition-colors"
            />
          </div>
